...
module Kempelen
  module API
    module Operations
      class GetHitTest < Minitest::Test
        def setup
          @client = Kempelen::API::Client.new("A", "B", :sandbox)
          @operation = Kempelen::API::Operations::GetHit.new(@client, "HIT_ID")
        end
        ...
        def test_create_parameters
          ...
          assert_equal Kempelen::API::Operations::GetHit::AWS_OPERATION_NAME, @operation.parameters[:operation]
