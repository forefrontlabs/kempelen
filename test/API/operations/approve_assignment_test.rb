...
module Kempelen
  module API
    module Operations
      class ApproveAssignmentTest < Minitest::Test
        def setup
          @client = Kempelen::API::Client.new("A", "B", :sandbox)
          @operation = Kempelen::API::Operations::ApproveAssignment.new(@client, "ASSIGNMENT_ID")
        end
        ...
        def test_create_parameters
          ...
          assert_equal Kempelen::API::Operations::ApproveAssignment::AWS_OPERATION_NAME, @operation.parameters[:operation]
        ...
        def test_create_request_string_will_create_required_parameters_with_feedback
          operation = Kempelen::API::Operations::ApproveAssignment.new(@client, "ASSIGNMENT_ID", "REQUESTER_FEEDBACK")
